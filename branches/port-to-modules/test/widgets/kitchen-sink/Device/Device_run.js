...
function clickItResult(){
    switch (flag) {
	    ...
	    case "clickshowwidgetEngineProvidertest":
	        ...
	        break;
	    case "clickshowwidgetEngineVersiontest":
	        clickshowwidgetEngineVersiontest();
	        break;
	    ...
	    case "phoneUserUniqueIdAction":
	        ...
	        break;
	    case "userAccountBalanceAction":
	    	userAccountBalanceAction();
	        break;
	    case "userSubscriptionTypeAction":
	    	userSubscriptionTypeAction();
	        break;
	    ...
	    case "getbackLightOnAction":
	        ...
	        break;
	    case "getAccelerometerInfoAction":
	        getAccelerometerInfoAction();
	        break;
