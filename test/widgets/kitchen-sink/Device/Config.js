...
function showConfigtest() {
    var Configtest = document.getElementById("Configtest");
...
function clickItmsgRingtoneVolume() {
    ...
    document.getElementById("textdivshowExplanation").innerHTML = " The volume of the ringtone to be played when a new message arrives, which takes the value from 0 to 10, where 0 is off.";
...
function clickItringtoneVolume() {
    ...
    document.getElementById("textdivshowExplanation").innerHTML = " The volume of the ringtone, which takes the value from 0 to 10, where 0 is off.";
    document.getElementById("textdivshowInitialCondition").innerHTML = "Notice : n/a";
