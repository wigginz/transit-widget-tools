...
function showDevicetest() {
    var Devicetest = document.getElementById("Devicetest");
...
function clickItcopyFile() {
    ...
    document.getElementById("textdivshowSampleCode").innerHTML = "e.g. var b = Widget.Device.copyFile(\"/sdcard/test1.txt\", \"/sdcard/test2.txt\");";
    flag = "clickcopyFile";
}
...
function clickItgetFile() {
   ...
   document.getElementById("textdivshowSampleCode").innerHTML = "E.g. var files = Widget.Device.getFile(\"/sdcard/test1.txt\");";
   flag = "clickgetFile";
}

function clickgetFile() {
   var filePath = "/sdcard/test1.txt";
   var file = null;
   if (isNotEmpty(filePath)){
       file = Widget.Device.getFile(filePath);
   }
   if (file) {
...
function clickItdeleteFile() {
    ...
    document.getElementById("textdivshowInitialCondition").innerHTML = "Notice : Makesure the file exists in the correct path.";
    document.getElementById("textdivshowSampleCode").innerHTML = "e.g. var b = Widget.Device.deleteFile(\"/sdcard/test1.txt\");";
...
function clickdeleteFile() {
    ...
    if (b) {
        document.getElementById("textdivshowResult").innerHTML = "Result : Success! Delete file /sdcard/test1.txt.";
    } else {
        document.getElementById("textdivshowResult").innerHTML = "Result : Fail! Delete file /sdcard/test1.txt.";
    }
}
...
function clickItmoveFile() {
   ...
   document.getElementById("textdivshowInitialCondition").innerHTML = "Notice : Makesure the source file exists in the correct path.";
   document.getElementById("textdivshowSampleCode").innerHTML = "E.g. var b = Widget.Device.moveFile(\"/sdcard/test1.txt\", \"/sdcard/test2.txt\");";
   flag = "clickmoveFile";
}

function clickmoveFile() {
   var source = "/sdcard/test1.txt";
   var dest = "/sdcard/test2.txt";
   var b = null;
...
function clickItcreateFile() {
   ...
   document.getElementById("textdivshowSampleCode").innerHTML = "E.g. var b = Widget.Device.createFile(\"/sdcard/test3.txt\"); ";
...
function clickgetFileSystemRoots() {
    ...
    {
    	document.getElementById("textdivshowResult").innerHTML = "Result : " + roots[i];
    }
}
...
function clickItgetFileSystemSize() {
    ...
    document.getElementById("textdivshowInitialCondition").innerHTML = "Notice : Returns the size of the file system in Byte unit.";
