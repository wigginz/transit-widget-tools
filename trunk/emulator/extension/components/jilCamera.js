const INTERFACE = Components.interfaces.jilCamera; //#
const CLASS_ID = Components.ID("a6793ed1-bb5d-11de-8a39-0800200c9a66"); //#
const CLASS_NAME = "JIL API Camera"; //#
const CONTRACT_ID = "@jil.org/jilapi-camera;1"; //#
...
var JILCameraFactory = { //#
  createInstance: function (aOuter, aIID)
  {
    ...
    if ( service == null )
      return(new JILCamera()).QueryInterface(aIID);
    else 
      return(service);
  }
};
...
function NSGetModule(aCompMgr, aFileSpec) { return JILCameraModule; } //#