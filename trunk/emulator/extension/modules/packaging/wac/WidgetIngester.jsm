...
var WidgetIngester =
{
  ...
  ingest : function(domDoc, baseUrl)
  {
    ...
    {
      TransitCommon.alert("Could not ingest widget config.xml, reason: "+ex.message+". Cannot load WAC widget.");
  ...
  **/
  ...
  ingest_1_0 : function(config, baseUrl)
  {
    ...
    // TODO change to reflect WAC if the namespace of the widget is http://www.w3.org/ns/widgets, it's a 1.2 widget
